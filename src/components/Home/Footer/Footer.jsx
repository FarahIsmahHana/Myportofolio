...
const Footer = () => {
  return (
    <div className="bg-[#97d3dd] mt-20 p-5 text-center text-[#1f1f38]">
      <h1 className="text-3xl font-semibold mt-16 hover:text-white duration-300 cursor-default ">Farah Ismah Hana</h1>
      ...
      <div className="flex justify-center gap-5 mb-7 ">
        <a href="https://www.facebook.com/farah.i.hana" target="_blank">
        ...
        <a href="https://www.instagram.com/hanafharaa/" target="_blank">
        ...
        <a href="https://www.linkedin.com/in/farah-ismah-hana-071922242/" target="_blank">
      ...
      <h5 className="mb-[10rem] text-[13px] ">&copy; Farah Ismah Hana Portfolio. All rights reserved</h5>
    </div>
  );
};

...
const Portfolio = () => {
  return (
    <div id="portfolio" className="w-full md:p-2  ">
      ...
      <h1 className="text-center text-2xl text-[#97d3dd] mt-1 ">Portfolio</h1>

      <div className=" md:w-[500px] md:ml-[15%] lg:ml-[31%] lg:w-[600px] ml-50">
        {data.map(({ id, image, title, github, demo }) => {
          return (
            <article key={id} className="bg-[#0c606e] border-[1px] border-transparent  hover:bg-transparent hover:border-[#97d3dd] duration-300 cursor-default rounded-3xl mx-5 mt-4 text-center">
              <div className="p-4">
